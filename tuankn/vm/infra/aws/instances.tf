#create ec2 bastion-01 filter ami canonical
...
#mount elastic ip to vpc and ec2 via id
resource "aws_eip_association" "bastion" {
  allocation_id = aws_eip.bastion.id
  instance_id   = aws_instance.bastion.id
}

#create ec2 web filter from ami job1
...
#create ec2 app filter from ami job1
